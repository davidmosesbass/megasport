...
button:{class:"btn btn-secondary"},collection:{tag:"div",class:"dropdown-menu",button:{tag:"a",class:"dt-button dropdown-item",active:"active",disabled:"disabled"}}},buttonCreated:function(a,d){return a.buttons?b('<div class="btn-group"/>').append(d):d}});a.ext.buttons.collection.class+=" dropdown-toggle";a.ext.buttons.collection.rightAlignclass="dropdown-menu-right";return a.Buttons});
