...
this.c.dom.container.tag+"/>").addClass(this.c.dom.container.class)};this._constructor()};e.extend(n.prototype,{action:function(a,b){var c=this._nodeToButton(a);if(b===m)return c.conf.action;c.conf.action=b;return this},active:function(a,b){var c=this._nodeToButton(a),d=this.c.dom.button.active,c=e(c.node);if(b===m)return c.hasClass(d);c.toggleClass(d,b===m?!0:b);return this},add:function(a,b){var c=this.s.buttons;if("string"===typeof b){for(var d=b.split("-"),e=this.s,c=0,f=d.length-1;c<f;c++)e=
...
typeof c){if(!p[c])throw"Unknown button type: "+c;c=p[c]}d++;if(30<d)throw"Buttons: Too many iterations";}return Array.isArray(c)?c:e.extend({},c)},a=g(a);a&&a.extend;){if(!p[a.extend])throw"Cannot extend unknown button type: "+a.extend;var f=g(p[a.extend]);if(Array.isArray(f))return f;if(!f)return!1;c=f.class;a=e.extend({},f,a);c&&a.class!==c&&(a.class=c+" "+a.class);var h=a.postfixButtons;if(h){a.buttons||(a.buttons=[]);c=0;for(d=h.length;c<d;c++)a.buttons.push(h[c]);a.postfixButtons=
null}if(h=a.prefixButtons){a.buttons||(a.buttons=[]);c=0;for(d=h.length;c<d;c++)a.buttons.splice(c,0,h[c]);a.prefixButtons=null}a.extend=f.extend}return a},_popover:function(a,b,c){var d=this.c,g=e.extend({align:"button-left",autoClose:!1,background:!0,backgroundclass:"dt-button-background",contentclass:d.dom.collection.class,collectionLayout:"",collectionTitle:"",dropup:!1,fade:400,rightAlignclass:"dt-button-right",tag:d.dom.collection.tag},c),f=b.node(),h=function(){x(e(".dt-button-collection"),
g.fade,function(){e(this).detach()});e(b.buttons('[aria-haspopup="true"][aria-expanded="true"]').nodes()).attr("aria-expanded","false");e("div.dt-button-background").off("click.dtb-collection");n.background(!1,g.backgroundclass,g.fade,f);e("body").off(".dtb-collection");b.off("buttons-action.b-internal")};!1===a&&h();c=e(b.buttons('[aria-haspopup="true"][aria-expanded="true"]').nodes());c.length&&(f=c.eq(0),h());c=e("<div/>").addClass("dt-button-collection").addClass(g.collectionLayout).css("display",
"none");a=e(a).addClass(g.contentclass).attr("role","menu").appendTo(c);f.attr("aria-expanded","true");f.parents("body")[0]!==q.body&&(f=q.body.lastChild);g.collectionTitle&&c.prepend('<div class="dt-button-collection-title">'+g.collectionTitle+"</div>");w(c.insertAfter(f),g.fade);var d=e(b.table().container()),k=c.css("position");"dt-container"===g.align&&(f=f.parent(),c.css("width",d.width()));if("absolute"===k&&(c.hasClass(g.rightAlignclass)||c.hasClass(g.leftAlignclass)||"dt-container"===
g.align)){var l=f.position();c.css({top:l.top+f.outerHeight(),left:l.left});var j=c.outerHeight(),i=d.offset().top+d.height(),t=l.top+f.outerHeight()+j,i=t-i,t=l.top-j,m=d.offset().top,u=l.top-j-5;(i>m-t||g.dropup)&&-u<m&&c.css("top",u);var l=d.offset().left,d=d.width(),d=l+d,k=c.offset().left,s=c.width(),s=k+s,o=f.offset().left,p=f.outerWidth(),p=o+p,o=0;c.hasClass(g.rightAlignclass)?(o=p-s,l>k+o&&(k=l-(k+o),d-=s+o,o=k>d?o+d:o+k)):(o=l-k,d<s+o&&(k=l-(k+o),d-=s+o,o=k>d?o+d:o+k));c.css("left",
