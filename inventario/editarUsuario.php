...
<div class="wrapper">
 ...
 <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form action="../logica/editarUsuario.php" method="post">
          <?php 
            ...
            if($r->num_rows > 0){
                while($row = $r->fetch_assoc()){
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="id" disabled value="<?php echo $row["id_usuario"] ?> " > 
                    </div>
                    <div class="form-group">
                      <label for="nombre">Nombre</label>
                      <input type="text" class="form-control" name="nombre" value="<?php echo $row["nombre_usuario"] ?> " > 
                    </div>
                    <div class="form-group">
                      <label for="">Email</label>
                      <input type="text" class="form-control" name="email" value="<?php echo $row["email_usuario"] ?>"> 
                    </div>
                    <div class="form-group">
                      <label for="">Rol</label>
                      <input type="text" class="form-control" name="rol" value="<?php echo $row["id_perfilusr"] ?>"> 
                    </div>
                    <div class="form-group">
                      <label for="">Bloqueo de usuario</label>
                      <input type="text" class="form-control" name="bloqueo" value="<?php echo $row["bloqueo_usuario"] ?>">
                    </div>
                    <div class="form-group">
                      <label for="">Estado</label>
                      <input type="text" class="form-control" name="estado" value="<?php echo $row["estado_usuario"] ?>"> 
                    </div>
                          <?php 
