...
upper:g("<div/>").addClass(this.classes.subRow1).addClass(this.classes.narrowSearch)};this.s.displayed=!1;a=this.s.dt;this.selections=[];this.s.colOpts=this.colExists?this._getOptions():this._getBonusOptions();var l=this.s.colOpts,c=g('<button type="button">X</button>').addClass(this.classes.paneButton);g(c).text(a.i18n("searchPanes.clearPane","X"));this.dom.container.addClass(l.class);this.dom.container.addClass(null!==this.customPaneSettings&&void 0!==this.customPaneSettings.class?this.customPaneSettings.class:
...
function(a,b,d,c,f,h,e){for(var l,g=0,j=this.s.indexes;g<j.length;g++){var i=j[g];i.filter===b&&(l=i.index)}void 0===l&&(l=this.s.indexes.length,this.s.indexes.push({filter:b,index:l}));return this.s.dtPane.row.add({class:e,display:""!==a?a:!1!==this.s.colOpts.emptyMessage?this.s.colOpts.emptyMessage:this.c.emptyMessage,filter:b,index:l,shown:d,sort:""!==f?f:!1!==this.s.colOpts.emptyMessage?this.s.colOpts.emptyMessage:this.c.emptyMessage,total:c,type:h})};n.prototype._adjustTopRow=function(){var a=
